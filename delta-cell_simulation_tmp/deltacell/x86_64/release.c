...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 22, 5);
 	...
 	ivoc_help("help ?1 rel /panfs/pan01/vol006/home/coml-islet-simulations/univ4198-islet/bHub_sim/delta-cell_simulation/deltacell/x86_64/release.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   ...
   _zkfv = k1 * FA * Ves ;
   Dcai = - ( 1e4 ) * 2.0 * ica / ( FARADAY * diam ) + ( 1e-3 ) * ( C0 - ( 1e3 ) * cai ) / tau ;
 ...
 _zbfc = b * ( Fmax - FA - VA ) * pow( cai , 4.0 ) ;
 _zkfv = k1 * FA * Ves ;
 Dcai = Dcai  / (1. - dt*( ( (( 1e-3 ))*(( ( - (( 1e3 ))*(1.0) ) )) ) / tau )) ;
 DFA = DFA  / (1. - dt*( ( - (u)*(1.0) ) )) ;
...
static void _initlists(){
 ...
 _slist1[1] = &(FA) - _p;  _dlist1[1] = &(DFA) - _p;
 _slist1[2] = &(VA) - _p;  _dlist1[2] = &(DVA) - _p;
 _slist1[3] = &(T) - _p;  _dlist1[3] = &(DT) - _p;
 _slist2[0] = &(FA) - _p;
 _slist2[1] = &(T) - _p;
 _slist2[2] = &(VA) - _p;
 _slist2[3] = &(cai) - _p;
