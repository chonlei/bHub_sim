...
np.savetxt('figure3a_raw_top-nonhub.txt', Xall)
Xall[Xall>0.2] = 1
Xall[Xall<1] = 0
np.savetxt('figure3a_raster_top-nonhub.txt', Xall.astype(int), fmt='%i')
...
np.savetxt('figure3a_raw_middle-nonhub.txt', Xall)
Xall[Xall>0.2] = 1
Xall[Xall<1] = 0
np.savetxt('figure3a_raster_middle-nonhub.txt', Xall.astype(int), fmt='%i')
...
np.savetxt('figure3a_raw_bottom-nonhub.txt', Xall)
Xall[Xall>0.2] = 1
Xall[Xall<1] = 0
np.savetxt('figure3a_raster_bottom-nonhub.txt', Xall.astype(int), fmt='%i')
...
plt.savefig("../figures/raster-%d-nonhub.png"%CASE,bbox_inches='tight')
plt.savefig("../figures/raster-%d-nonhub.pdf"%CASE,format='pdf',bbox_inches='tight')
